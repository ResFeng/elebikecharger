...
var vm = new Vue({
	...
	methods : {
		...
		save: function() {
			dialogOpen({
				title: '新增',
				url: 'sc/scserial/add.html?_' + $.now(),
				width: '420px',
				height: '350px',
		...
		edit: function(id) {
            dialogOpen({
                title: '编辑',
                url: 'sc/scserial/edit.html?_' + $.now(),
                width: '420px',
                height: '350px',
                success: function(iframeId){
                    top.frames[iframeId].vm.scSerial.id = id;
